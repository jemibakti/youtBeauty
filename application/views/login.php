...
<html lang="en-us" id="extr-page">
	<head>
		...
		<meta name="description" content="Youth and Beauty Clinic">
		<meta name="author" content="Youth and Beauty Clinic">
	...
	<body class="animated fadeInDown">
		...
		<header id="header">
			...
			<div id="logo-group">
				<span id="logo"> <b>Youth and Beauty Clinic</b> </span>
			</div>
		</header>
			...
			<div id="content" class="container">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-7 col-lg-8 hidden-xs hidden-sm">
						<h1 class="txt-color-red login-header-big"></h1><br/>
						<div class="hero">
							<div class="pull-left login-desc-box-l">
							<br/>
							<img src="<?php echo base_url().'assets/'; ?>img/demo/logo.png" class="pull-left display-image" alt="" style="width:400px">
							</div>
						</div>
					</div>
					<div class="col-xs-12 col-sm-12 col-md-5 col-lg-4">
						<div class="well no-padding">
							<form action="<?php echo site_url('auth/login') ?>" method="post" id="login-form" class="smart-form client-form">
								<header>
									Sign In
								</header>
								<fieldset>									
