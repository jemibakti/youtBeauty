        ...
        <div id="content">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                    <a href="<?php echo base_url()."/AdminWeb/simpanFile/".$group_id."/".$jenis;?>">
                        ...
                        <div>
                                ...
                                <div class="widget-body no-padding">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                            <tr>
                                                <td class="text-center"><?php echo tumb('img/'.$row->file_name,false); ?></td>
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group dropup">
                                                        ...
                                                        <ul class="dropdown-menu pull-right text-left">
                                                            ...
                                                            <li>
                                                                <div class="padding-5">
                                                                    <a href="<?php echo base_url()."/AdminWeb/treatmentDetail/".base64_encode($row->id);?>">
                                                            ...
                                                            <li>
                                                                <div class="padding-5">
                                                                    <a href="<?php echo base_url()."/AdminWeb/updateFile/".base64_encode($row->id."|".$group_id."|".$jenis);?>">
                                                            ...
                                                            <li>
                                                                <div class="padding-5">
                                                                    <a href="<?php echo base_url()."/AdminWeb/deleteStatus/".base64_encode("m_pictrue|".$row->id."|adminWeb|".$group_id."|".$jenis);?>">
