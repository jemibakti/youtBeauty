...
<div class="row">
	...
	<div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
		...
		<a data-toggle="modal" href="<?php echo base_url().'assets/';?>#myModal" class="btn btn-success btn-lg pull-right header-btn hidden-mobile"><i class="fa fa-circle-arrow-up fa-lg"></i> Launch form modal</a>
	</div>
</div>

<div class="alert alert-block alert-success">
	<a class="close" data-dismiss="alert" href="<?php echo base_url().'assets/';?>#">×</a>
						...
						<form action="php/demo-comment.php" method="post" id="comment-form" class="smart-form">
							...
							<fieldset>
								...
								<section>
									...
									<div class="note">
										You may use these HTML tags and attributes: &lt;a href="<?php echo base_url().'assets/';?>" title=""&gt;, &lt;abbr title=""&gt;, &lt;acronym title=""&gt;, &lt;b&gt;, &lt;blockquote cite=""&gt;, &lt;cite&gt;, &lt;code&gt;, &lt;del datetime=""&gt;, &lt;em&gt;, &lt;i&gt;, &lt;q cite=""&gt;, &lt;strike&gt;, &lt;strong&gt;.
									</div>
								</section>
							</fieldset>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog">
	<div class="modal-dialog">
								...
								<section>
									<div class="row">
										...
										<div class="col col-10">
											...
											<div class="note">
												<a href="<?php echo base_url().'assets/';?>javascript:void(0)">Forgot password?</a>
											</div>
										</div>
									</div>
								</section>
		...
		<div id="shortcut">
			<ul>
				<li>
					<a href="<?php echo base_url().'assets/';?>inbox.html" class="jarvismetro-tile big-cubes bg-color-blue"> <span class="iconbox"> <i class="fa fa-envelope fa-4x"></i> <span>Mail <span class="label pull-right bg-color-darken">14</span></span> </span> </a>
				</li>
				<li>
					<a href="<?php echo base_url().'assets/';?>calendar.html" class="jarvismetro-tile big-cubes bg-color-orangeDark"> <span class="iconbox"> <i class="fa fa-calendar fa-4x"></i> <span>Calendar</span> </span> </a>
				</li>
				<li>
					<a href="<?php echo base_url().'assets/';?>gmap-xml.html" class="jarvismetro-tile big-cubes bg-color-purple"> <span class="iconbox"> <i class="fa fa-map-marker fa-4x"></i> <span>Maps</span> </span> </a>
				</li>
				<li>
					<a href="<?php echo base_url().'assets/';?>invoice.html" class="jarvismetro-tile big-cubes bg-color-blueDark"> <span class="iconbox"> <i class="fa fa-book fa-4x"></i> <span>Invoice <span class="label pull-right bg-color-darken">99</span></span> </span> </a>
				</li>
				<li>
					<a href="<?php echo base_url().'assets/';?>gallery.html" class="jarvismetro-tile big-cubes bg-color-greenLight"> <span class="iconbox"> <i class="fa fa-picture-o fa-4x"></i> <span>Gallery </span> </span> </a>
				</li>
				<li>
					<a href="<?php echo base_url().'assets/';?>profile.html" class="jarvismetro-tile big-cubes selected bg-color-pinkDark"> <span class="iconbox"> <i class="fa fa-user fa-4x"></i> <span>My Profile </span> </span> </a>
				</li>
			</ul>
		</div>
		<!-- END SHORTCUT AREA -->
